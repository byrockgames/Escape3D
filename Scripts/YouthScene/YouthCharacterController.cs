...
public class YouthCharacterController : MonoBehaviour
{
    ...
    public AudioSource aSourceHorn;
    ...
    void SliderController()  //  Slider Controller
    {
        ...
        {
            EnergySlider.value -= 0.0003f * Time.deltaTime;
        }
    ...
    IEnumerator FinishDanceController()
    {
